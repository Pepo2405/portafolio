...
export const WindowsProvider: FC<Props> = ({ children }) => {
  ...
  const [visibleItems, setVisibleItems] = useState({ Proyectos: false, Mochify: true })
  const [minimizedItems, setMinimizedItems] = useState({ Proyectos: false, "Mochi Draw": false, "Mochify": true })
  ...
  return (
    <WindowsContext.Provider value={{ minimizedItems, visibleItems, setVisibleItems, handleClose, handleOpen, setMinimizedItems, handleMaximize, handleMinimize }}>
      {children}
