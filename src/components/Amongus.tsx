...
const Amongus = (props: Props) => {
  ...
  return (
    <div className='w-20 h-20 flex justify-center items-center mt-3 absolute bottom-16 left-2'>
      ...
      <div onClick={handleCLick} className='w-20 h-20' style={{ width: "96px", height: "96px", backgroundImage: `${dead ? DeadIcon : AmogusIcon}`, backgroundSize: "5rem", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}></div>
    </div>
  )
}
